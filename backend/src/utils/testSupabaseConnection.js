...
async function testConnection() {
  ...
  try {
    ...
    console.log(`Current count of records in 'scripts' table: ${count === null ? 'N/A (head:true used)' : count}`);
    ...
    console.log('If count is a number (even 0), the connection and table access are working.');
